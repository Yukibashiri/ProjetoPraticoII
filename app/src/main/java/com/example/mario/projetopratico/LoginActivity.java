...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCadastro = (TextView)findViewById(R.id.action_criar_conta);
        txtRecuperarSenha = (TextView) findViewById(R.id.action_esqueceu_senha);
        ...
        txtAcessoSemLogin = (TextView) findViewById(R.id.action_entrar_sem_conta);

        txtCadastro.setOnClickListener(new View.OnClickListener() {
           public void onClick(View v) {
                   Intent novaTela = new Intent(LoginActivity.this, CadastroActivity.class);
                   LoginActivity.this.startActivityForResult(novaTela, 1);
           }
        });
        ...
        txtRecuperarSenha.setOnClickListener(new View.OnClickListener() {
            public void onClick(View j) {
                ...
                LoginActivity.this.startActivityForResult(i,2);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if (requestCode == 1){
            if (resultCode == RESULT_OK){
                Snackbar.make(telaLogin, getString(R.string.info_cadastro_sucesso), Snackbar.LENGTH_LONG).show();
            }
        }
        else
        {
